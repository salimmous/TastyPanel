...
${WEB_USER} ALL=(root) NOPASSWD:${APP_DIR}/infrastructure/tenant-env-keys.sh
${WEB_USER} ALL=(root) NOPASSWD:${APP_DIR}/infrastructure/tenant-artisan.sh
${WEB_USER} ALL=(root) NOPASSWD:${APP_DIR}/infrastructure/tenant-deploy.sh
